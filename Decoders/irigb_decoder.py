...
class IRIGB_Decoder():
    ...
    def irig_decoder(self, pulsebits):
        ...
        self.Seconds = float((pulsebits[0] * 1) + (pulsebits[1] * 2) + (pulsebits[2] * 4) + (pulsebits[3] * 8) + (
                pulsebits[5] * 10) + (pulsebits[6] * 20) + (pulsebits[7] * 40))
        self.Minutes = (pulsebits[8] * 1) + (pulsebits[9] * 2) + (pulsebits[10] * 4) + (pulsebits[11] * 8) + (
                pulsebits[13] * 10) + (pulsebits[14] * 20) + (pulsebits[15] * 40)
        self.Hours = (pulsebits[17] * 1) + (pulsebits[18] * 2) + (pulsebits[19] * 4) + (pulsebits[20] * 8) + (
                pulsebits[22] * 10) + (pulsebits[23] * 20)
        ...
        self.SBS = float((pulsebits[71] * (2 ** 0)) + (pulsebits[72] * (2 ** 1)) + (pulsebits[73] * (2 ** 2)) + (
                pulsebits[74] * (2 ** 3)) + (pulsebits[75] * (2 ** 4)) + (pulsebits[76] * (2 ** 5)) + (
                                 ...
                                 pulsebits[80] * (2 ** 9)) + (pulsebits[81] * (2 ** 10)) + (
                             pulsebits[82] * (2 ** 11)) + (
                                 pulsebits[83] * (2 ** 12)) + (pulsebits[84] * (2 ** 13)) + (
                             pulsebits[85] * (2 ** 14)) + (
